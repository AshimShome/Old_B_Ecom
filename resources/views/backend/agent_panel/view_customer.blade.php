                    ...
                    <div class="card-body">
                        <div class="d-lg-flex col-lg-10 mb-2">
                            ...
                            <div class="col-lg-7 addReturnAblePrdBtn">
                                <a href="{{ route('role.agent_panel.add_customer', config('fortify.guard')) }}"><button
                                        type="button" class="btn btn-success waves-effect waves-light mb-2 me-2">Add New Customer <i class="fas fa-user-plus"></i> </button></a>
                            </div>
                        </div>
                        <div>
                            <div class="row">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting sorting_asc" tabindex="0"
                                                    ...
                                                    style="width: 140.75px;">Customer ID</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Customer Name: activate to sort column ascending"
                                                    style="width: 177.516px;">Customer Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Email: activate to sort column ascending"
                                                    style="width: 223.281px;">Email</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Mobile Number: activate to sort column ascending"
                                                    style="width: 176.516px;">Mobile Number</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Customer Address: activate to sort column ascending"
                                                    style="width: 477.25px;">Customer Address</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Customer Address: activate to sort column ascending"
                                                    style="width: 477.25px;">Action</th>    
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>
                                                     <button class="btn btn-info"> <a href="https://bppshops.com/admin/pos_agent/pos">Start Shoping</a></button>
                                                 <button class="btn btn-success"><a href="{{ route('role.agent_panel.order_details', [config('fortify.guard'), $customer->id]) }}">View Order Info</a></button>
