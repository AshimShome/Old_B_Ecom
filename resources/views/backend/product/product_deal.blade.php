                                            ...
                                            <div class="col-lg-6">
                                                <form method="POST" action="" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="product_id" class="select2-multiple  form-control" data-toggle="select2" id="deals">
                                                                <option >Product ID and Product Name</option>
...
<script>
  $(document).ready(function() {
      $('.select2-multiple').select2({
          placeholder: "Product ID and Product Name",
          allowClear: true
      });
