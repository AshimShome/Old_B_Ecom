            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    <div class="col-9 m-auto">
                        <div class="card">
                            <div class="card-title banner-header-title" style="color: black; font-weight: bold;">Banner
                            </div>
                            <div class="card-body">
                                            ...
                                            <table id="datatable-buttons"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{asset($banner->bennar_img)}}" alt="..."
                                                                height="150" width="300">
                                                        </td>
                                                        <td>{{ optional($banner->ecommerce)->ecom_name }}</td>
                                                        ...
                                                        <td>
                                                            <a href="{{route('role.bennar.edit',[config('fortify.guard'),$banner->id ])}}"
                                                                class="btn btn-success"><i class="fas fa-edit"></i></a>
                                                            <a href="{{route('role.bennar.delete',[config('fortify.guard'),$banner->id ])}}"
                                                                class="btn btn-danger"><i class="fas fa-trash"></i></a>\
                                                            @if($banner->status ==1)

                                                            <a href="{{route('role.bennar.deactive',[config('fortify.guard'),$banner->id])}}"
                                                                class="btn btn-danger"><i
                                                                    class="fas fa-arrow-down"></i></a>
                                                            @else
                                                            <a href="{{route('role.bennar.active',[config('fortify.guard'),$banner->id])}}"
                    ...
                    <div class="col-lg-3">
                        <form method="POST" action="{{ route('role.bennar.store',config('fortify.guard'))  }}"
                            enctype="multipart/form-data">
                            <div class="add-banner-container">
                                <h3 style="text-align: center">Add Banner</h3>
                                @csrf
                                <div class="form-group">
                                    <h5>Ecommerce Name <b style="color:red; font-size:20px; font-weight:bold">*</b> <span class="text-danger"></span></h5>
                          ...
                          oninvalid="this.setCustomValidity('Please Select E-com Name')" oninput="this.setCustomValidity('')">
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="btn btn-rounded btn-info"
                                        style="background-color: #269746" value="Add Banner">
                                </div>
