                                    ...
                                    <div class="table-responsive">
                                        <form method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" required
                                                        value="{{ $supplier->supplyer_phone }}" id="number"
                                                        name="supplyer_phone" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="file" id="supplyer_photo" name="image"
                                                        class="form-control">
