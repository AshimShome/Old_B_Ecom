                        ...
                        <div class="card-body">
                            <div class="order-details-btn-wrap">
                                <div class="order-details-btn-inner">
                                    ...
                                    <!-- <br> -->
                                    <a href="#" class="btn jfss-order-btn jfss-order-btn4">{{ optional($order)->invoice_no }}</a>
                                </div>
                            ...
                            <table id="datatable-buttons" class="datatable-buttons table table-striped nowrap w-100">
                                ...
                                <tbody>
                                    @foreach ($order->orderItems as $item)
                                        <tr>
                                            <td><img src="{{ asset(optional($item->product)->product_thambnail) }}" alt="img1" width="67px;" height="57px"> </td>
                                            ...
                                            <td>{{ optional($item->product)->purchase_price }} TK.</td>
                                            ...
                                            <td class="text-center">
                                                <span class="main text-center buttonHolder">
                                                    @if ($item->pending_status === 1)
                                                        <button class="success statusButton" data-status="1" data-id="{{ $item->id }}">Available</button>
                                                    @elseif($item->pending_status === 0)
                                                        <button class="cancel statusButton" data-status="0"data-id="{{ $item->id }}">Not Available</button>
                                                    @endif
                                                </span>
                                            </td>
                                            <td class="text-center">
