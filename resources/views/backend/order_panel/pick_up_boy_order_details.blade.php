...
@section('main-content')
    <div class="content">
        <div class="container-fluid">
            <div class="row mt-4">
                <h3 class="pb-2 header-title" style="color: red">Product Packing Employee Page</h3>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                              ...
                              <div class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($orderItems as $item)
                                        <tr>
                                            <td>
                                                <img src="{{ asset(optional($item->product)->product_thambnail) }}" alt="img1" width="67px;" height="57px"> 
                                            ...
                                            <td class="text-center">
                                                @if ($item->picked_employee_status == null)
                                                    <div class="sideMain">
                                                        ...
                                                        <div class="temp">
                                                            <button class="success statusButton" data-status="1"
                                                                data-id="{{ $item->id }}">Pick Complete</button>
                                                            <button class="cancel statusButton" data-status="0"
                                                                data-id="{{ $item->id }}">Pick Not Complete</button>
                                                        </div>
...
@section('script')
    <script>
        ...
        $('.statusButton').on('click', function() {
            ...
            $.ajax({
                url: `/admin/order/pickUpBoyOrderProcessingStatusSet`,
                type: "POST",
                data: {
                    status: itemStatus,
                    id: itemid,
