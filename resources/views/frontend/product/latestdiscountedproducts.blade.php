                             ...
                             @if($subsubcat->product_qty>0)
                              <div class="isotopeSelector filter all ec-card-lg">
                                            ...
                                            <div class="border-portfolio">
                                                <div class="card product-port">
                                                    <div class="image-overlay-container">
                                                        <a href="{{route('ProductDetails_islamic',[$subsubcat->category_id,$subsubcat->sub_category_id,$subsubcat->product_slug_name ] )}}"> <img src="{{asset($subsubcat->product_thambnail ) }}"
                                                            alt="portfolio-image"></a>
                                                        
                                                    </div>
                                                    <div class="text-center my-3">
                                                        <a href="{{route('ProductDetails_islamic',[$subsubcat->category_id,$subsubcat->sub_category_id,$subsubcat->product_slug_name ] )}}"> <h4 class="text-dark">{{ $subsubcat->product_name }}</h4></a>
                                                    
                                                    <br>
                                                    <h4 class="mb-1">{{ $subsubcat->unit }}</h4>
                                                    ...
                                                    @else
                                                    <h4>
                                                        <span style="color:black;font-weight:bold; font-size: 16px;" > <span style="color:black;font-weight:bold; font-size: 16px;">৳</span>
                                                            {{ intval($subsubcat->discount_price) }}</span>
                                                        <span><s class="text-danger" style="font-weight:bold; font-size: 16px;"><span style="font-weight:bold; font-size: 16px;">৳</span>
                                       ...
                                       <a href="{{route('ProductDetails_islamic',[$subsubcat->category_id,$subsubcat->sub_category_id,$subsubcat->product_slug_name ] )}}"
                                         ><button
                                            class="btn btn-primary-filled px-4"><i class="fas fa-cart-plus me-2"></i>Shop Now
                                        </button></a>
                                        </div>
                                            </div>
                                        </div>
                              ...
                              <div class="isotopeSelector filter all ec-card-lg">
                                        <div class="overlay ec-card-inner">
                                            <div class="border-portfolio">
                                                <div class="card product-port">
                                                    <div class="image-overlay-container">
                                                        <a > <img src="{{asset($subsubcat->product_thambnail ) }}"
                                                            alt="portfolio-image"></a>
                                                        
                                                    </div>
                                                    <div class="text-center my-3">
                                                        <a> <h4 class="text-dark">{{ $subsubcat->product_name }}</h4></a>
      ...
      <div class="isotopeSelector filter all ec-card-lg">
             <div class="overlay ec-card-inner">
                <div class="border-portfolio">
                   <div class="card product-port">
                      <div class="image-overlay-container">
                      <a > <img src="/${value.product_thambnail}" class="img-fluid  bg-img"
                            alt="portfolio-image"></a>
                        
                      </div>
                      <div class="text-center my-3">
                      <a  href="/product/detail/${value.category_id}/${value.sub_category_id}/${value.product_slug_name }"> <h4 class="text-dark">${value.product_name} </h4></a>
                        <br>
                         <small class="mb-1" style=" font-size: 16px;">${value.unit}</small>
                          <!-- Selling and Discount Price Start -->
                                        ${value.discount_price < 1 ?
                                          `
                                          <h4 sstyle="color:black;font-weight:bold; font-size: 16px;"> <span style="font-size:15px">৳</span>
                                             ${parseInt(value.selling_price)} </h4>
                                          `
                                          :
                                          `
                                          <h4>
                                            <span style="color:black;font-weight:bold; font-size: 16px;"> <span style="font-size:15px">৳</span>
                                                 ${parseInt(value.discount_price) } </span>
                                            <span><s class="text-danger" style="font-weight:bold; font-size: 16px;"><span style="font-size:15px">৳</span>
                   ...
                   <div class="d-flex justify-content-center cart-details-btn">
                     <a class="btn btn-primary-filled px-4" href="/product/detail/${value.category_id}/${value.sub_category_id}/${value.product_slug_name }" ><i class="fas fa-shopping-cart"></i>Shop Now</a>
             ...
             <div class="overlay ec-card-inner">
                <div class="border-portfolio">
                   <div class="card product-port">
                      ...
                      <div class="text-center my-3">
                      <a > <h4 class="text-dark">${value.product_name} </h4></a>
                   ...
                   <div class="d-flex justify-content-center cart-details-btn">
                     <a class="btn btn-primary-filled px-4" disabled><i class="fas fa-shopping-cart"></i> Stock Out</a>
