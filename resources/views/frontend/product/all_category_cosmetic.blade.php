...
@section('islamic')
    ...
    .cosmetic-featured-category-container{
        min-height: 90vh;
    }
    
    .cosmetic-category-cont{
        display: flex;
        flex-wrap: wrap;
        justify-content: center;
    }
    .cosmetic-featured-category-container .featured-category .featured-category-item{
        margin: 15px;
    }
</style>
    ...
    <main class="main-body fashion-home">
        <section class="main-content category-closed" id="main-content">
            ...
            <div class="section-title-no-bg">
                <h4 class="pt-5 text-center">All Categories</h4>
            </div>
            <div class="featured-category mt-5 px-md-1 px-2">
                <div class="container px-2 px-md-1">
                    <div class="row">
                        <div class="col">
                            <div class="cosmetic-category-cont">
                                ...
                                <div>
                                    <a href="{{ url('/cbs/'. $category->category_slug_name) }}">
                                        <div class="featured-category-item text-center">
                                            ...
                                            <h6 class="catName mt-3">{{ $category->category_name }}</h6>
                                        </div>
                                    </a>
                                </div>
                                @endforeach
