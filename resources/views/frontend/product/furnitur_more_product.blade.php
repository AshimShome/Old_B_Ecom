...
<section class="main-content furniture-home" id="main-content">
    <div class="container-fluid profile px-md-5 px-3 mt-3">
        <!--~~~~~~category page banner starts~~~~~~-->
         ...
         @php
    $products = App\Models\Product::where('status', 1)->where('ecom_name', '7')->get();
    @endphp
 <section class="product-section section-padding">
        <div class="">
                    ...
                    <div class="loading_img_section d-block text-center" style="display: none";"pointer-events: none"><img  src="https://i.gifer.com/4V0b.gif" alt="Bppshops" ></div>
                </div>
      <!-- end container  -->
  </section>
