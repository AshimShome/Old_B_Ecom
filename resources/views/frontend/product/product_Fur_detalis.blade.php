            ...
            <div class="container-fluid profile px-md-5 px-3 mt-3">
                ...
                <div class="breadcrumb-main">
                    <ul class="category-breadcrumb-product">
                        <li class="breadcrumb-item"><a href="{{ url('/furniture') }}">Home</a></li>
                                           ...
                                           <div class="row product-choose-innr">
                                            ...
                                            <div class="product-details-quantity mb-3">
                                                ...
                                                <div class="product-buttons">
                                                    <a style="background-color: #223E3F;" href="javascript:void(0)" id="cartEffect"
                                                        onclick="addToCartProductDetailsFurnitur({{ $product->id }}, <?php echo $productName; ?>)"
                        ...
                        <div class="d-md-flex align-items-start px-md-5 px-3 ">
                            <div class="">
                                ...
                                <div class="nav nav-pills me-3  d-flex flex-md-column flex-wrap " id="v-pills-tab"
                                    ...
                                    <!-- ---------------------- Side Buttons -------------------------- -->
                                    <button  style="background-color: #223E3F;" class="btn prod-btn active" id="v-pills-my-account-tab" data-bs-toggle="pill"
