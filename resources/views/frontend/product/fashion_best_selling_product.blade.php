                                  ...
                                  @if($subsubcat->product_qty == 0)
                                    ...
                                    <div class="card gallery-item woman">
                                        <div class="gallery-item-inner woman">
                                            ...
                                            <img src="{{asset($subsubcat->product_thambnail ) }}" alt="{{ $subsubcat->product_slug_name }}" class="product-img">
                                            </a>
                                            <div class=" card-body">
                                                <a  
                                                id="fashion_details_link" ><h4 class="gallery-card-heading">{{ $subsubcat->product_name }}</h4></a>
