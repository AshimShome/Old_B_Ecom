...
<section class="main-content category-closed baby-subcat" id="main-content">
    <div class="container-fluid p-0">
       ...
       <div class="row subcat-product-wrapper p-5">

            @forelse($baby_getsubcategory as $subcategory)
              <div class="col-lg-2 col-md-4 col-12">
                <a  class="soc-btn" href="{{ url('/bbs/' . $subcategory->category->category_slug_name .'/'. $subcategory->sub_category_slug_name) }}">
                 <div class="subcat-item">
                    <div class="subcat-thumb">
                       <img src="{{ asset($subcategory->subcategory_image) }}"  height="200px" alt="sub-cat-img">
                    </div>
                    <div class="subcat-overlay">
                       <div class="sub-overlay-content">
                          <div class="soc-top">
                             <!--<h4 style="color:black; text-align:center; margin-top: 10px">{{ $subcategory->sub_category_name }} ({{ $subcategory->products_list->count()}})</h4>-->
