...
<style>
    ...
    .cos_sub_cat_lipstick .lipstick_card_container .cardPart a img {

        height: 200px;
    }

    .cos_sub_cat_lipstick .lipstick_card_container .cardPart {
        text-align: center;
    }
                                ...
                                <li>
                                    ...
                                    <div class="collapse {{ Request::segment(3) != $subcategory->sub_category_slug_name? '' : 'show' }}"
                                        ...
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small sub-sub-category">
                                            ...
                                            <li><a href="{{ url('/cbs/'.optional($subsubcategory->category)->category_slug_name.'/'. optional($subsubcategory->subcategory)->sub_category_slug_name.'/'. optional($subsubcategory)->subsubcategory_slug_name) }}"
    ...
    <section class="cos_sub_cat_lipstick container">
        ...
        <div class="lipstick_card_container row">
            ...
            <div class="col-lg-3">
                <div class="cardPart">
                    <a
                        href="{{ url('/cbs/'.$subsubcategory->category->category_slug_name.'/'. $subsubcategory->subcategory->sub_category_slug_name.'/'. $subsubcategory->subsubcategory_slug_name) }}">
                        <img class="img-fluid" src="{{ asset($subsubcategory->subsubcategory_image) }} " alt="">
                        <p class="title">{{ $subsubcategory->subsubcategory_name }}</p>
                    </a>
                </div>
            </div>
            @empty
            <h4 style="text-align: center;margin-top:100px;margin-bottom-200px;font-color:#d9dbde;"><i>Not Found</i>
            </h4>
            @endforelse
        </div>
                        ...
                        <div class="overlay ec-card-inner">
                            <div class="border-portfolio">
                                ...
                                <div class="d-flex justify-content-center cart-details-btn">
                                    ...
                                    {{-- <a onclick="productView({{ $subsubcat->id }})" data-bs-toggle="modal"
                                        data-bs-target="#productQuickViewModal"><button
                                            class="btn-primary-filled-grocery px-4"><i
