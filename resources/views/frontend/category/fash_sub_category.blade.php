...
@section('islamic')
<style>.wrap_left img{ height: 250px;width: 100%;}</style>
                 ...
                 <div class="col-lg-6 col-md-6 com-sm-12 mt-1">
                    <div class="subcat_banner_img h-100">
                        <div class="wrap_left h-100">
                            <img src=" {{ asset( $banner->subcat_banner_image) }}" alt="" class="img-fluid" style="height: 200px; width: 100%">
                        </div>
                    </div>
                </div>
                   @endforeach
                ...
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb category-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a
                                href="{{url('product/fashion/category/Product')}}">All Category</a></li>
                    </ol>
                </nav>
                <!-- breadcrumb end -->
