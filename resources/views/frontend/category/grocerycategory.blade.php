    ...
    <ul id="category-toggle-custom-sidemenu" class="category-sidemenu">
       ...
       $coupons = App\Models\Coupon::where('status','1')->orderBy('id', 'DESC')->count();
        ...
        <li class="menu-heading">
            <a href="{{ url('/special/grocery/offer') }}"><span class="text">Special Offers</span> <span class="number">{{ $special_offer }}</span></a>
                            ...
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small sub-category">
                                ...
                                <li>
                                    ...
                                    <a href="{{ url('/gbs/' . $subcategory->category->category_slug_name .'/'. $subcategory->sub_category_slug_name) }}">
                                        @endif
                                        <button class="btn btn-toggle align-items-center rounded {{ Request::segment(3) != $subcategory->sub_category_slug_name? 'collapsed' : '' }}"
                        ...
                        <div id="subcategoryShow{{ $category->id }}" class="ec-card-lg categoryBox subCategroyCard">
                            <a href="{{ url('/gbs/'. $category->category_slug_name) }}">
                                ...
                                <div class="ec-card-inner text-center">
                                    ...
                                    <h1 style="font-size:16px;font-weight:400px;color:#777;">{{ $category->category_name }} ({{$category->products_list->count()}})</h1>
                                </div>
                            </a>
                        </div>
                       @empty
