...
@section('islamic')
    ...
    <main class="main-body">
        ...
        <!-- Modal -->
        <div class="modal fade" style="z-index: 999999" id="standard-modal" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    <form id="addAddress">
                            ...
                            <div class="checkout-form-inner">
                                ...
                                <div class="row form-row ">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="floor_no" value=""
                                            placeholder="e.g 1,2">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <input type="text" name="appartment_no" class="form-control" value=""
                                            placeholder="example#2-A,3-B">
                                    </div>
                                    <!-- end col  -->
                                    ...
                                    <div class="col-lg-12 col-md-12 ">
                                        <label for="validationCustomUsername" class="label_name">Phone Number <b
                                                class="text-danger">*</b></label>
                                        <div class="input-group has-validation">
                                            <span class="input-group-text mb-2 bg-light" id="inputGroupPrepend">+88</span>
                                            <input value="{{ Auth::user()->mobile }}" type="text" name="phone_no"
                                                class="form-control" id="validationCustomUsername"
                                                aria-describedby="inputGroupPrepend" placeholder="e.g +8801611815656">
                        ...
                        <div class="modal-footer justify-content-center">
                            <div class="btn">
                                <button type="submit" class="saveBtn btn2 btn add_btn"
                                    style="background-color:#fc5f00c2"> SAVE ADDRESS </button>
                            </div>
                        </div>
                                ...
                                <div class="checkout-form-wrap">
                                    <div class="deliver-add-wrapper addForm">
                                        <div class="location_card">
                                            <h4><i class="fa-solid fa-location-dot pe-2"></i> Select a Delivery Address
                                                <span class="text-danger">**</span></h4>
                                        </div>

                                        <div class="add_addres d-none" id="add_addres">
                                            <button type="button" class="btn btn-outline-secondary"
                                                data-bs-toggle="modal" data-bs-target="#standard-modal"> + Add Address
                                            </button>
                                        </div>
                                        <form action="{{ route('checkout.process') }}" method="POST" id="checkoutForm">
                                            ...
                                            @if (Session::has('addressMessage'))
                                                <p class="text-danger" style="text-align:center">
                                                    {{ Session::get('addressMessage') }}</p>
                                            @endif
                                            ...
                                            <div class="deliver-add-wrapper mt-3">
                                                ...
                                                <div class="row d-flex justify-content-center m-3 m-lg-5">
                                                    <p style="display: flex; justify-content: center;"><i
                                                            class="fas fa-shipping-fast"
                                                            style="margin: 2px 13px;"></i>When would you like your Express
                                                        Delivery</p>
                                                    ...
                                                    <div class="btn-container dropdown">
                                                        ...
                                                        <ul name="preferred_date" class="dropdown-options">
                                                            @foreach ($dates as $date)
                                                                @if ($loop->first)
                                                                    <li class="option">
                                                                        <a class="link DateField" href="#"
                                                                            value="{{ \Carbon\Carbon::now()->format('d-m-Y') }}">Today
                                                                            <br>
                                                                            {{ \Carbon\Carbon::createFromFormat('m/d/Y', $date)->format('F d') }}</a>
                                                                    </li>
                                                                @elseif($loop->iteration == 2)
                                                                    <li class="option">
                                                                        <a class="link DateField" href="#"
                                                                            value="{{ \Carbon\Carbon::tomorrow()->format('d-m-Y') }}">Tomorrow
                                                                            <br>
                                                                            {{ \Carbon\Carbon::createFromFormat('m/d/Y', $date)->format('F d') }}
                                                                        </a>
                                                                    </li>
                                                                @else
                                                                    <li class="option">
                                                                        <a class="link DateField" href="#"
                                                                            value="{{ \Carbon\Carbon::createFromFormat('m/d/Y', $date)->format('d-m-Y') }}">{{ \Carbon\Carbon::createFromFormat('m/d/Y', $date)->format('l') }}
                                                                            <br>
                                                                            {{ \Carbon\Carbon::createFromFormat('m/d/Y', $date)->format('F d') }}</a>
                                                                    </li>
                                                                @endif
                                            ...
                                            <div>
                                                <p
                                                    style="text-aligne:center;text-align: center;font-size: 20px; color: #000803;">
                                                    Grocery Product Delivery within 3 Hours <br>Others Items Delivery within
                                                    2-4 Days</p>
                                            </div>
                                            <div class="paymentoption-left">
                                                ...
                                                <div class="form-check mt-3">
                                                    <input class="form-check-input" type="radio" name="payment_method"
                                                        value="cash" id="flexRadioDefault1" checked>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="payment_method"
                                                        value="card" id="flexRadioDefault2">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="payment_method"
                                                        value="stripe" id="flexRadioDefault2">
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        Mobile Banking
                                                    </label>
                                                </div>
                                            ...
                                            <div class="btn-right">
                                                <p style="color: #D66826;" class="this_btn mb-3">৳ <span
                                                        class="fw-bold me-1">50.00</span> Delivery charge included for
                                                    Dhaka City Corporation</p>
                                                <p style="color: #D66826;" class="this_btn mb-3">৳ <span
                                                        class="fw-bold me-1">120.00</span> Delivery charge included for
                                                    Outside Dhaka</p>
                                                <button type="submit" class="btn btn-primary btn-lg d-flex proceed">
                                                    <div class="text">Proceed</div>
                                                    <div class="price">৳ {{ $total_amount }}</div>
                                                </button>
                                                <p class="mt-2">By clicking/tapping proceed, I agree to BPP SHOPS
                                                    Ecommerce <a href="{{ route('info.terms') }}">Terms of Services</a>
                                                </p>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        if (!$.trim(response)) {
                            ...
                            s = `<div class="add_addres border border-1 border-success">
                                    <div class="p-1 d-flex justify-content-between"  style="color:black;margin-left: 20px">
                                        <div>
                                            <input type="text" readonly id="newAddress" value="${response.street_address} ${response.post_codes.postOffice}, ${response.district.name}" name="address" class="form-control">
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            s = `<div class="add_addres border border-1 ${value.status == 1 ?'border-success':''} select_address"  data-address_id="${value.id}">
                                    <div class="p-1 d-flex justify-content-between"  style="color:black;margin-left: 20px">
                                        <div>
                                            ${value.street_address} <br> <b>${value.post_codes.postOffice}, ${value.district.name}</b>
                                        </div>
        ...
        <script>
            $("[name='payment_method']").on('change',function()
            {
                ...
                if(this.value =='cash' )
                {
                    let tempURL = `${baseURL}/checkout/process`;
                    $('#checkoutForm').attr('action',tempURL);
                }
                if(this.value =='card' )
                {
                    let tempURL = `${baseURL}/easyPayment`;
                    $('#checkoutForm').attr('action',tempURL);
                }
