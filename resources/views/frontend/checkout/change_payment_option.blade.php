                              ...
                              <div class="card card-payments">
                                 <div class="card-body">
                                    ...
                                    <div class="card-img d-flex justify-content-center align-items-center">
                                       <img style="height:60px;weight:60px; " src=" {{ asset('/frontend/assets/images/checkout/my_grocery_cart3.webp') }} " alt="" class="img-fluid">
                                    </div>
                                    <!-- end card-img  -->
                                    ...
                                    <div class="payment-box d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="payment-del-box">
                                          <p>
                                             ...
                                             Cash on Delivery : <span> ৳  {{ floatval($payments->amount) + floatval($payments->delivery_charge) }}</span>
                                          </p>
                                       </div>
                                       <!-- end payment-del-box  -->
                              ...
                              <div class="card order-details-card">
                                 <div class="card-body">
                                    ...
                                    <div class="card-body-details-innr">
                                       ...
                                       <!-- end details-order  -->
                                       <div class="details-order d-flex justify-content-between align-items-center">
                                          <h6> Order Total (Incl. VAT): </h6>
                                          <h6 class="price-text">&#2547; {{ $payments->amount }}</h6>
                                       </div>
                                       <div class="details-order d-flex justify-content-between align-items-center">
                                          <h6> Delivery Charge: </h6>
                                          <h6 class="price-text">&#2547; {{ $payments->delivery_charge }}</h6>
                                       </div>
                                       <div class="details-order d-flex justify-content-between align-items-center">
                                          <h6> Grand Total: </h6>
                                          <h6 class="price-text">&#2547; {{ floatval($payments->amount) + floatval($payments->delivery_charge) }}</h6>
                                       </div>
                                       <!-- end details-order  -->
                                       <div class="details-order d-flex justify-content-between align-items-center">

                                                    <h6 class="me-2"> Address: </h6>

                                                    <h6 class="text-end">{{ $payments->street_address }}</h6>
                                       </div>
                                       <!-- end details-order  -->
