...
<style>
    ...
    .form-select-custom option::selection {
        background-color: #ef8341;
        color: white;
    }
        ...
        <form id="addAddress">
            <div class="modal-content">
                        ...
                        <div class="row form-row ">
                            ...
                            <div class="col-lg-12 col-md-12 ">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input   value="{{ Auth::user()->mobile }}" type="text" name="phone_no" class="form-control" id="validationCustomUsername"
                                        aria-describedby="inputGroupPrepend" placeholder="e.g 01611815656">
                ...
                <div class="modal-footer">
                   <div class="btn">
                    <button type="submit"  class="saveBtn btn2 btn add_btn" style="background-color: #ef8341 !important; color:white"> SAVE ADDRESS </button>
                   </div>
                </div>
            </div><!-- /.modal-content -->
        </form>
...
<section class="container  user-profile-section px-4 py-5">      
            <div class="row">
            <form method="POST" class="" action="{{ route('user.profile.store') }}" enctype="multipart/form-data" >
                        @csrf
               <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <!-- end profile-header  -->
                   <div class="profile-wrapper mb-4">
                        ...
                        <input type="text" class="" name="email" id="email" placeholder="" value="{{ $user->email }}">
                           ...
                           <span class="line"></span>
                          <a href="{{route('verification.notice')}}" class="btn jfss-ver-btn d-none">Verify</a>
                        </div>
                        
                        <div class="brise-input">
                          <input type="text" class="" name="phone"  id="phone" placeholder="" value="{{ $user->mobile }}" value="{{ $user->phone }}">
                           <label>Phone Number </label>
                           
                        </div>
                       
                        <div class="brise-input" style="border-bottom: 1px solid #D9D9D1;">
                             <h6 class="gen-hed text-dark">Select Gender <b class="text-danger">*</b> </h6>
                           <select class="form-select-custom input-style " style="border-bottom: 0px solid #D9D9D1; font-size: 20px; height: 41px;" name="gender" aria-label="Default select example">
                              <option selected>{{ $user->gender }}</option>
                              <option value="Female" style="color:black; background-color: white">Female</option>
                              <option value="Male" style="color:black; background-color: white">Male</option>
                              <option value="Other" style="color:black; background-color: white">Other</option>
                           </select>
                           @error('gender')
                                <span class="text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="brise-input">
                        <input type="date" name="date_of_birth" class="d-flex" style="padding-right:540px; font-size: 20px" value="{{ $user->date_of_birth }}">
                         <label class="text-dark">Date Of Birth  <b class="text-danger">*</b></label>
                     ...
                     <div class="card">
                        <div class="card-header p-3">
                           <div class="card-top-innr">
                              <h4> <i class="fa-solid fa-location-dot"></i> Select a Delivery Address</h4>
                  ...
                  <!-- end profile-del-card-wrapper  -->
                    ...
                    <div class="text-center mt-2">
                        <button type="submit" class="btn btn-warning update-btn">Update Profile</button>
                    </div>
                ...
                success: function (response) {
                    ...
                    $.each( response, function( key, value ) {
                            ...
                            s = `<div class="add_addres border border-1 ${value.status == 1 ?'border border-warning':''} row"  style="padding:5px;" >
                                ...
                                ${value.status == 1 ?'':`<a href="#" class="btn btn-outline-danger  btn-sm  delete_address ${value.status == 1 ? '':'col-4'}"  data-id="${value.id}"  style="margin-top: 4px;width: 66px; margin-bottom: 18px; margin-left: auto;" > Delete </a>`}
                            </div>`;
