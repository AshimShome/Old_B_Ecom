...
(function ($) {
    ...
    $(' <div class="tap-top" style="display: block;margin: -20px;"><i class="fas fa-arrow-up"></i></div>').appendTo($('body'));
...
function quickViewQunatityIncr(e,pQty) {  
    let productQty=pQty;
    let productQuantity= document.getElementById('productQuantity').value;
   let faruk = productQty-productQuantity;       
  console.log(faruk);
            
    if (e.target.previousElementSibling === null && productQuantity < productQty) {
         e.target.parentElement.previousElementSibling.value++;
...
// ------------------------  Grocery Add Increment and Decrement Button ------------------------

function showIncDecBtn_Overlay(e) {
    ...
    e.target.parentElement.parentElement.nextElementSibling.children[1].style.display = "block";

  }

  function showIncDecBtn_Bottom(e) {



    e.target.parentElement.previousElementSibling.children[2].children[0].style.display = "none";



    e.target.parentElement.previousElementSibling.children[2].children[1].style.display = "block";
  ...
  // grocery overlay increment button

  function quickViewQunatityIncrOverlay(e) {

    var quantity_text = document.getElementsByClassName("quantity-text").value;

    var pro_price = document.getElementsByClassName("pro-price");

    pro_price = quantity_text * pro_price;

    if (e.target.nextElementSibling === null) {

      e.target.parentElement.nextElementSibling.value++;

      e.target.parentElement.parentElement.parentElement.parentElement.parentElement.nextElementSibling.children[1].children[0].children[1].value++;
      ...
      e.target.parentElement.parentElement.parentElement.parentElement.nextElementSibling.children[1].children[0].children[1].value++;
  ...
  // grocery overlay decrement button

  function quickViewQunatityDecOverlay(e) {
    ...
    if (e.target.previousElementSibling === null) {
      ...
      if (e.target.parentElement.previousElementSibling.value > 1) {
        ...
        e.target.parentElement.parentElement.parentElement.previousElementSibling.style.display = "block";
        ...
        e.target.parentElement.parentElement.parentElement.parentElement.parentElement.nextElementSibling.children[0].style.display = "block";

        e.target.parentElement.parentElement.parentElement.parentElement.parentElement.nextElementSibling.children[1].style.display = "none";
  ...
  // grocery increment button



  function quickViewQunatityIncrButton(e) {

    if (e.target.nextElementSibling === null) {

      e.target.parentElement.nextElementSibling.value++;

      e.target.parentElement.parentElement.parentElement.parentElement.previousElementSibling.children[2].children[1].children[1].children[1].value++;
      ...
      e.target.parentElement.parentElement.parentElement.previousElementSibling.children[2].children[1].children[1].children[1].value++;
  ...
  // grocery decrement button

  function quickViewQunatityDecButton(e) {
    ...
    if (e.target.previousElementSibling === null) {
      ...
      if (e.target.parentElement.previousElementSibling.value > 1) {
        ...
        e.target.parentElement.parentElement.parentElement.parentElement.previousElementSibling.children[2].children[0].style.display = "block";

        e.target.parentElement.parentElement.parentElement.parentElement.previousElementSibling.children[2].children[1].style.display = "none";
  ...
  // Fashion Slick Slider

// Our Product Categories Slider

$(".fash-best-sale-pro").slick({
...
//=============== cosmetic count down timer for mega sale ==================//

(function () {

    function megaSaleCountDown() {

      const setTime = new Date("30 Jun 2022");

      const currentTime = new Date();

      const dueTime = setTime - currentTime;

      const dueDays = Math.floor(dueTime / 1000 / 60 / 60 / 24);

      const dueHours = Math.floor((dueTime / 1000 / 60 / 60) % 24);

      const dueMinutes = Math.floor((dueTime / 1000 / 60) % 60);

      const dueSeconds = Math.floor((dueTime / 1000) % 60);



      document.getElementById("countDay").innerText = dueDays;

      document.getElementById("countHour").innerText = dueHours;

      document.getElementById("countMin").innerText = dueMinutes;

      document.getElementById("countSec").innerText = dueSeconds;

    }

    setInterval(megaSaleCountDown, 1000);

  })();



  $(".cosmetic-slide-2").slick({
  ...
  //=================cosmetic slide 1 start ====================== //

  $(document).ready(function () {

    $(".cosmetic-slide-1").slick({
  ...
  // cosmetic discount product slider

  $(document).ready(function () {

    $(".cosmetic_prd_discount_container").slick({
  ...
  // cosmetic newly Launched product slider

  $(document).ready(function () {

    $(".launched_prd_slider").slick({
  ...
  // cosmetic mega sale slider

  $(document).ready(function () {

    $(".mega_sale_slider").slick({
...
$(".furniture-pro-cate").slick({
    ...
    responsive: [
...

      {
        ...
        $('.furniture-owl-carousel').owlCarousel({
        ...
        var owl = $(".furniture-owl-carousel");
...
//   ------------------------for Electronics------------------
   ...
   $('.featured-new-topsales-slide').slick({
      ...
      //-------------------------- Deals of The Day Start for Electronics-----------------------------
      ...
      $('.deals-of-the-day-slide').slick({
        ...
        //-------------------------- Display Products Slide for Electronics -----------------------------
  ...
  //=============== countdown custom coding   ========================

//   (function () {

//     const daysUi = document.getElementById("countDownDay");

//     const hoursUi = document.getElementById("countDownHours");

//     const minutesUi = document.getElementById("countDownMinutes");

//     const secondsUi = document.getElementById("countDownSeconds");

//     console.log(daysUi)

//     // initialize CountDown time

//     const offerTime = "22 May 2022";

//     function countDown() {

//       const offerTimeObj = new Date(offerTime);

//       const currentTime = new Date();

//       const dueTime = (offerTimeObj - currentTime) / 1000;

//       const dueDays = Math.floor(dueTime / 3600 / 24);

//       const dueHours = Math.floor((dueTime / 3600) % 24);

//       const dueMinutes = Math.floor((dueTime / 60) % 60);

//       const dueSeconds = Math.floor(dueTime % 60);

//       daysUi.innerText = dueDays;

//       hoursUi.innerText = dueHours;

//       minutesUi.innerText = dueMinutes;

//       secondsUi.innerText = dueSeconds;

//       // cosmetic feature category slider
...
//   })();
  ...
  (function () {
    ...
    const sliders = document.querySelectorAll('#end_date_slider');
    ...
    for (let index = 0; index < sliders.length; index++) {
        ...
        const daysUi = element.querySelector(".countDownDay");

        const hoursUi = element.querySelector(".countDownHours");

        const minutesUi = element.querySelector(".countDownMinutes");

        const secondsUi = element.querySelector(".countDownSeconds");



        // initialize CountDown time

        const offerTime = element.querySelector(".end_date_expire").innerText;
...
$(document).ready(function () {
  ...
  function toggleFeaturedNewTopSalesElectornic(id) {
